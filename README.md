...
note:   
This comment helped me get a running version on python3 (https://github.com/dimatura/pypcd/issues/7#issuecomment-596867258).  
...
use:   
pip3 install --upgrade git+https://github.com/manasrda/pypcd.git  
then:   
